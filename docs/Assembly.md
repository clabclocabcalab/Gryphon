...
LSR rA (rB/im) rC: Logical shift rC right by (rB/im) and put result in rA
LSL rA (rB/im) rC: Logical shift rC left by (rB/im) and put result in rA
ASR rA (rB/im) rC: Arithmetic shift rC right by (rB/im) and put result in rA
